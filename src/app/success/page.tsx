      ...
      <div className="bg-gradient-to-br from-green-50 to-white py-24">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          {apiKey && (
            <div className="bg-white rounded-lg shadow-lg p-6 mb-8">
              ...
              <div className="flex items-center bg-gray-50 rounded-lg p-4">
                <code className="flex-1 text-left font-mono text-sm text-gray-800 break-all">
                  {apiKey}
                </code>
                <button
          ...
          <div className="space-y-4">
            <a
              href="/docs"
              className="inline-block bg-primary-600 text-white px-6 py-3 rounded-lg font-semibold hover:bg-primary-700 transition-colors mr-4"
            >
              View Documentation
            </a>
            <a
