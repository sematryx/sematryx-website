        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
              <a
                href="https://github.com/sematryx/sematryx-api/blob/kubernetes-migration/notebooks/tutorials/01_sematryx_quick_start.ipynb"
                target="_blank"
              ...
              <a
                href="https://github.com/sematryx/sematryx-api/blob/kubernetes-migration/notebooks/tutorials/02_portfolio_optimization.ipynb"
                target="_blank"
                rel="noopener noreferrer"
                className="bg-elevated rounded-xl p-6 border border-elevated-3 hover:border-brand-primary/50 transition-all group"
              >
              ...
              <a
                href="https://github.com/sematryx/sematryx-api/blob/kubernetes-migration/notebooks/tutorials/03_domain_examples.ipynb"
                target="_blank"
                rel="noopener noreferrer"
                className="bg-elevated rounded-xl p-6 border border-elevated-3 hover:border-brand-primary/50 transition-all group"
              >
              ...
              <a
                href="https://github.com/sematryx/sematryx-api/blob/kubernetes-migration/notebooks/tutorials/04_mcp_agent_demo.ipynb"
                target="_blank"
                rel="noopener noreferrer"
                className="bg-elevated rounded-xl p-6 border border-elevated-3 hover:border-brand-primary/50 transition-all group"
              >
              ...
              <a
                href="https://github.com/sematryx/sematryx-api/blob/kubernetes-migration/notebooks/tutorials/05_conversational_optimization.ipynb"
                target="_blank"
                rel="noopener noreferrer"
                className="bg-elevated rounded-xl p-6 border border-elevated-3 hover:border-brand-primary/50 transition-all group"
              >
