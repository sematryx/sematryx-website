      ...
      <div className="space-y-8">
        ...
        <section>
          ...
          <ol className="list-decimal list-inside space-y-2 text-gray-700 mb-4">
            <li>Visiting the <a href="/api-keys" className="text-primary-600 hover:text-primary-700 underline">API Keys page</a></li>
        ...
        <section>
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6">
            <h3 className="text-lg font-semibold text-yellow-900 mb-3">Keep Your API Key Secure</h3>
