        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6 text-lg text-text-secondary leading-relaxed">
              ...
              <p>
                <strong className="text-text-primary">Our Target Audience:</strong> We serve data science teams, operations managers, and technical leaders at mid-to-large enterprises in financial services, healthcare, manufacturing, supply chain, and energy sectors. Our customers need optimization solutions that can handle complexity, provide explanations, and maintain compliance with industry regulations.
              </p>
            </div>
