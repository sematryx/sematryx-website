...
const overageRates = [
  ...
  },
  {
    ...
    pro: '$0.50/GB',
    enterprise: 'Included',
    description: 'Beyond included storage'
  }
]
      ...
      <div className="container mx-auto px-6">
          ...
          {tiers.map((tier) => (
            ...
            >
              ...
              {tier.privateLearning && (
                <div className="mb-6 p-3 bg-bg-primary/50 rounded-lg border border-gray-700">
                  <p className="text-xs font-semibold text-accent-primary mb-2">Private Learning Store</p>
                  <ul className="space-y-1 text-xs text-gray-400">
                    <li>• {tier.privateLearning.storage}</li>
                    <li>• {tier.privateLearning.accessIncluded} access/mo</li>
                  </ul>
                </div>
              )}
        ...
        <div className="mt-16 text-center">
          <p className="text-text-secondary">
            ...
            <a href="/docs" className="text-accent-primary hover:underline">documentation</a>
            {' '}or{' '}
