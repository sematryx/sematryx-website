        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {differentiators.map((item, index) => (
            <div key={index} className="text-center group">
              <div className="w-14 h-14 mx-auto mb-6 bg-elevated border border-elevated-3 rounded-2xl flex items-center justify-center text-2xl group-hover:scale-110 group-hover:border-brand-primary/30 transition-all duration-300 shadow-lg shadow-black/20">
                {item.icon}
              </div>
